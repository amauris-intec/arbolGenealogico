...
public partial class arbolGenealogicoLexer : Lexer {
	...
	public arbolGenealogicoLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public arbolGenealogicoLexer(ICharStream input, TextWriter output, TextWriter errorOutput)
